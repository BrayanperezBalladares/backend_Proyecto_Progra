    ...
    public class MyAppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Reserva>().HasData(
                ...
                new Reserva { ReservaId = 10, ClienteId = 10, MesaId = 2, TurnoId = 3, EstadoDeReservaId = 1, CantidaPersonas = 2, Fecha = new DateTime(2026, 6, 18), HoraInicio = new DateTime(2026, 6, 18, 18, 0, 0), HoraFin = new DateTime(2026, 6, 18, 22, 0, 0) },
                ...
                new Reserva { ReservaId = 13, ClienteId = 13, MesaId = 7, TurnoId = 3, EstadoDeReservaId = 1, CantidaPersonas = 3, Fecha = new DateTime(2026, 6, 19), HoraInicio = new DateTime(2026, 6, 19, 18, 0, 0), HoraFin = new DateTime(2026, 6, 19, 22, 0, 0) },
